			...
			<table>
				<tbody>
					<tr>
						...
						<td><%=certificateValidationResponse.getName() %></td>
					</tr>
					<tr>
						<th class="width-20"><strong>Last Name</strong></th>
						<td><%=certificateValidationResponse.getSurname1() %> <%=certificateValidationResponse.getSurname2() %></td>
					</tr>
					<tr>
						<th class="width-20"><strong>Number User Id</strong></th>
						<td><%=certificateValidationResponse.getNumberUserId() %></td>
					</tr>
					<tr>
						<th class="width-20"><strong>E-mail</strong></th>
						<td><%=certificateValidationResponse.getEmail() %></td>
					</tr>
					<tr>
						<th class="width-20"><strong>Ca Name</strong></th>
						<td><%=certificateValidationResponse.getCa() %></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><%=certificateValidationResponse.getType() %></td>
					</tr>
				</tbody>
			</table>
			<%}%>
