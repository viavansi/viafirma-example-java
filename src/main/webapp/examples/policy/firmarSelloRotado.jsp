				...
				<div class="group">
					...
					<%
									if (request.getParameter("firmar") != null) {
										...
										//policy.addParameter(PolicyParams.DIGITAL_SIGN_RECTANGLE.getKey(), new org.viafirma.cliente.vo.Rectangle(5,100,420,75));
									    policy.addParameter(PolicyParams.DIGITAL_SIGN_RECTANGLE.getKey(), new org.viafirma.cliente.vo.Rectangle(520,250,420,75));
										...
										policy.addParameter(PolicyParams.DIGITAL_SIGN_STAMPER_ROTATION_ANGLE.getKey(), "90");
