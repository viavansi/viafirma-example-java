			...
			<div id="content">
				...
				<div class="group">
					<div class="col width-48 append-02">
						<div class="box">
							<h3 class="box-title">Firma pdf con sello generado por viafirma sin código de barras</h3>
							
							<div class="box-content">
								<p>Ejemplo de firma de documanto pdf con sello diseñado por viafirma que contiene el QRCode, texto con información de la firma e id de firma,
								 en el que se indica como generar el sello ocultando el código de barras.</p>
					...
					<%
									if (request.getParameter("firmar") != null) {
										...
										policy.addParameter(PolicyParams.DIGITAL_SIGN_STAMPER_HIDE_BARCODE.getKey(), "true");
						...
						<div class="box">
							...
							<div class="box-content">
								<ul>
									...
									<li>DIGITAL_SIGN_STAMPER_HIDE_BARCODE</li>
								</ul>
							</div>
						</div>
					</div>
