			...
			<div id="content">
				...
				<div class="group">
					<div class="col width-48 append-02">
						<div class="box">
							<h3 class="box-title">Firma de documento pdf usando SHA512 con RSA</h3>
					...
					<%
						if (request.getParameter("firmar") != null) {
							...
							policy.addParameter(PolicyParams.SIGNATURE_ALGORITHM.getKey(), SignatureAlgorithm.SHA512withRSA.toString());
