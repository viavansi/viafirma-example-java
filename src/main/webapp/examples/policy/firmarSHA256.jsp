...
<html>
	...
	<body>
		<div id="wrapper">
			...
			<div id="content">
				<h2>Algoritmo de firma por policy</h2>
			
				<div class="group">
					<div class="col width-48 append-02">
						<div class="box">
							<h3 class="box-title">Firma de documento pdf usando SHA256 con RSA</h3>
					...
					<%
						if (request.getParameter("firmar") != null) {
							...
							// Seteamos el algoritmo de firma
							policy.addParameter(PolicyParams.SIGNATURE_ALGORITHM.getKey(), SignatureAlgorithm.SHA256withRSA.toString());
