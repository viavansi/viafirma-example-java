			...
			<div id="content">
				...
				<div class="group">
					<div class="col width-48 append-02">
						<div class="box">
							<h3 class="box-title">Firma de documento pdf con Viafirma</h3>
							
							<div class="box-content">
								<p>Filtra por cualquier campo que pertenezca a algún atributo del certificado.</p>
					...
					<%
									if (request.getParameter("firmar") != null) {
										...
										policy.addParameter(PolicyParams.FILTER_GENERIC.getKey(), "{contains};FNMT-RCM;Tomares");
