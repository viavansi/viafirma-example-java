			...
			<div id="content">
				...
				<div class="group">
					<div class="col width-48 append-02">
						<div class="box">
							<h3 class="box-title">Firma pdf con sello generado por viafirma personalizando CSV</h3>
							
							<div class="box-content">
								<p>Ejemplo de firma de documanto pdf con sello diseñado por viafirma que contiene el QRCode, Bar Code, texto con información de la 
										firma e id de firma en el que se puede personalizar la URL de validación CSV.</p>
					...
					<%
									if (request.getParameter("firmar") != null) {
										...
										policy.addParameter(PolicyParams.DIGITAL_SIGN_RECTANGLE.getKey(), new org.viafirma.cliente.vo.Rectangle(40,40,550,75));
										...
										policy.addParameter(PolicyParams.DIGITAL_SIGN_STAMPER_CSV_URL.getKey(), "http://customurl.com/viafirma/v/");
						...
						<div class="box">
							...
							<div class="box-content">
								<ul>
									...
									<li>DIGITAL_SIGN_STAMPER_CSV_URL</li>
								</ul>
							</div>
						</div>
					</div>
