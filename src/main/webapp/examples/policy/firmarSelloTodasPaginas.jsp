...
<body>
	<div id="wrapper">
		<h1 id="header">
			<a href="../../"><img src="../../images/content/logo.png" alt="Viafirma" /></a>
		</h1>

		<div id="content">
			<h2>Firmar de documento pdf con justificate en todas las páginas</h2>

			<div class="group">
				<div class="col width-48 append-02">
					<div class="box">
						<h3 class="box-title">Firma de documento pdf con justificante en todas las paginas con Viafirma</h3>

						<div class="box-content">
							<p>En este ejemplo implementa la firma de un documento pdf con justificante de firma en todas las páginas haciendo uso del applet de
								Viafirma.</p>
				...
				<%
									if (request.getParameter("firmar") != null) {
										...
										byte[] datosAFirmar = IOUtils.toByteArray(getClass().getResourceAsStream("/example_3M.pdf"));	
										...
										/*
										//Pasar un listado de paginas para ponerles justificantes de firma
										List<String> pages = new ArrayList<String>();
										pages.add("1");
										pages.add("2");
										pages.add("3");
										policy.addParameter(PolicyParams.DIGITAL_SIGN_PAGE.getKey(), pages);
										*/
										//Justificantes de firma en TODAS las paginas
										policy.addParameter(PolicyParams.DIGITAL_SIGN_PAGE.getKey(), "0");										
										policy.addParameter(PolicyParams.DIGITAL_SIGN_RECTANGLE.getKey(), new org.viafirma.cliente.vo.Rectangle(100, 0, 400, 15));
										policy.addParameter(PolicyParams.DIGITAL_SIGN_STAMPER_HIDE_STATUS.getKey(), "true");
										policy.addParameter(PolicyParams.DIGITAL_SIGN_STAMPER_TEXT.getKey(), "Firmado por [CN] - NIF [SERIALNUMBER] - [vCSVKey]");
										policy.addParameter(PolicyParams.DIGITAL_SIGN_STAMPER_TRANSPARENT_BACKGROUND.getKey(), "true");
			...
			<div id="footer">
				<p class="left">
					Acceda a <a href="http://www.viafirma.com">Viafirma</a> o consulte más información técnica en <a
						href="http://developers.viafirma.com/">Viafirma Developers</a>
				</p>
				<p>
