				...
				<div class="group">
					...
					<%
									if (request.getParameter("firmar") != null) {
										...
										policy.addParameter(PolicyParams.DIGITAL_SIGN_RECTANGLE.getKey(), new org.viafirma.cliente.vo.Rectangle(40,10,300,150));
						...
						<div class="box">
							...
							<div class="box-content">
								<ul>
									...
									<li>DIGITAL_SIGN_REASON</li>
									<li>DIGITAL_SIGN_CONTACT</li>
									<li>DIGITAL_SIGN_LOCATION</li>
