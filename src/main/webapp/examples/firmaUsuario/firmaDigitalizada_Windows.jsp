...
// 										policy.addParameter(PolicyParams.DIGITALIZED_SIGN_LOGO.getKey(), logoStamp);
										...
										policy.addParameter(PolicyParams.DIGITALIZED_SIGN_BIOMETRIC_ALIAS.getKey(), ConfigureUtil.CERTALIAS);
									    policy.addParameter(PolicyParams.DIGITALIZED_SIGN_BIOMETRIC_PASS.getKey(), ConfigureUtil.CERTPASS);
...
// 									    policy.addParameter(PolicyParams.DIGITALIZED_SIGN_PAGE.getKey(), "3"); 
									    
									    //Firma en servidor del documento
										policy.addParameter(PolicyParams.DIGITALIZED_SIGN_ALIAS.getKey(), ConfigureUtil.CERTALIAS);
									    policy.addParameter(PolicyParams.DIGITALIZED_SIGN_PASS.getKey(), ConfigureUtil.CERTPASS);
