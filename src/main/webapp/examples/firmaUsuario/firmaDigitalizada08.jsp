<%@page import="org.viafirma.cliente.util.XadesADetachedResignUtil"%>
					...
					<div class="col width-53 append-02">
						<div class="box">
							...
							<div class="box-content">
								<p>En este ejemplo se realiza una firma <strong>digitalizada</strong> de un documento PDF 
								sin mostrar el sellado de tiempo de la firma digital en el documento PDF resultante.</p>
								...
								<%
									...
									if (request.getParameter("firmar") != null) {
										...
										byte[] datosAFirmar = IOUtils.toByteArray(getClass().getResourceAsStream("/rev1.pdf"));
										...
										policy.addParameter(PolicyParams.DIGITALIZED_SIGN_RECTANGLE.getKey(), new Rectangle(200,200,160,120));//He puesto estos de ejemplo
									    ...
									    policy.addParameter(PolicyParams.DIGITALIZED_SIGNATURE_FORMAT.getKey(), TypeFormatSign.XADES_T_ENVELOPED.name());
									    ...
									    policy.addParameter(PolicyParams.DIGITALIZED_SIGN_PAGE.getKey(), "2"); 
									  	
									    policy.addParameter(PolicyParams.DIGITAL_SIGN_STAMPER_HIDE_STATUS.getKey(), "true");
										policy.addParameter(PolicyParams.DIGITAL_SIGN_RECTANGLE.getKey(), new Rectangle(0,0,0,0));// Ocultamos el sellado de tiempo de la firma digital
								...
								<ul>
									...
									<li><code>Params:</code>
										<ul>
											...
											<li><code>PolicyParams.DIGITALIZED_SIGN_BIOMETRIC_ALIAS</code></li>
											<li><code>PolicyParams.DIGITALIZED_SIGN_BIOMETRIC_PASS</code></li>
											<li><code>PolicyParams.DIGITALIZED_SIGN_BIOMETRIC_CRYPTO_PEM</code></li>
											<li><code>PolicyParams.DIGITALIZED_SIGNATURE_FORMAT</code></li>
											<li><code>PolicyParams.DIGITALIZED_SIGN_ALIAS</code></li>
											<li><code>PolicyParams.DIGITALIZED_SIGN_PASS</code></li>
											<li><code>PolicyParams.DIGITALIZED_SIGN_PDF_SIGNATURE_FORMAT</code></li>
											<li><code>PolicyParams.DIGITALIZED_SIGN_PAGE</code></li>
											<li><code>PolicyParams.DIGITAL_SIGN_STAMPER_HIDE_STATUS</code></li>
											<li><code>PolicyParams.DIGITAL_SIGN_RECTANGLE</code></li>
										</ul>
									</li>
								</ul>
							</div>
