				...
				<div class="group">
					<div class="col width-63 append-02">
						<div class="box">
							...
							<div class="box-content">
								<p>En este ejemplo se realiza la autenticación del usuario a través de Viafirma con la intervención directa del usuario. 
								Se incluye la opción AUTO_SEND, es decir; si solo hay un certificado listado, se selecciona y envía de forma automática.</p>
					...
					<div class="col width-35">
						<div class="box">
							...
							<div class="box-content">
								<ul>
									<li><code>addOptionalRequest</code></li>
