...
<html>
	...
	<body>
		<div id="wrapper">
			...
			<div id="content">
					<h2>Método <code>checkCertificateByAlias</code></h2>
					
					<p>El método <code>checkCertificateByAlias</code> chequea la validez de un certificado alojado en el servidor.</p>
					...
					<ul class="parameters">
						<li><code>String alias</code> Alias del certificado a validar alojado en el servidor</li>
					</ul>
